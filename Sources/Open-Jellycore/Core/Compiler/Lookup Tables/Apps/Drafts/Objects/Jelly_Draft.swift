...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "identifier", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "displayString", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "uuid", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "link", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "content", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "title", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "tags", functionName: "Draft"), textPosition: node.textPosition)
//            }
...
//            } else {
//                EventReporter.shared.report(error: .parameterNotFound(parameter: "grammarType", functionName: "Draft"), textPosition: node.textPosition)
//            }
//
//        }
    }
