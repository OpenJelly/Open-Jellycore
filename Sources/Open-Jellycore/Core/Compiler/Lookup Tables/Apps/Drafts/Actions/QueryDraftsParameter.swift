...
struct QueryDraftsParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "queryString" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "queryString"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "folder" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "folder"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "tagFilter" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "tagFilter"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "flaggedStatus" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "flaggedStatus"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "sortOrder" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "sortOrder"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "sortDescending" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "sortDescending"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "sortFlaggedToTop" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "sortFlaggedToTop"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "limit" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "queryDrafts", name: "limit"), node: nil)
        }
