...
struct QueryRecordsParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "fields" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "fields"), node: nil)
        }
        if let variableCall = call.first(where: { node in return node.slotName == "input" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "input"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "outputType" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "outputType"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "hasWhere" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "hasWhere"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "whereClause" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "whereClause"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "hasGroupBy" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "hasGroupBy"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "groupByClause" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "groupByClause"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "hasOrderBy" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "hasOrderBy"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "orderByClause" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "orderByClause"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "hasLimit" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "hasLimit"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "limitClause" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "queryRecords", name: "limitClause"), node: nil)
        }
