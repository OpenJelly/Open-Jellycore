...
struct CreateWalletPassParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "title" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "title"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "descript" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "descript"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "barcode" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "barcode"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "barcodeData" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "barcodeData"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "barcodeLabel" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "barcodeLabel"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "type" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "type"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "transitType" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "transitType"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "from" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "from"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "to" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "to"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "genericPrimary" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "genericPrimary"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "couponPrimary" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "couponPrimary"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "eventTicketPrimary" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "eventTicketPrimary"), node: nil)
        }
        ...
        if let variableCall = call.first(where: { node in return node.slotName == "eventTicketThumbnail" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "eventTicketThumbnail"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "header" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "header"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "secondary" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "secondary"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "auxiliary" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "auxiliary"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "back" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "back"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "backgroundColor" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "backgroundColor"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "foregroundColor" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "foregroundColor"), node: nil)
        }
        ...
        if let variableCall = call.first(where: { node in return node.slotName == "logo" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "logo"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "location" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "location"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "distance" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "distance"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "date" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "createWalletPass", name: "date"), node: nil)
        }
