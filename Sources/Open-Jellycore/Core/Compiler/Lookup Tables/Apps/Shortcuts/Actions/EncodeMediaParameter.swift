...
struct EncodeMediaParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let variableCall = call.first(where: { node in return node.slotName == "media" })?.item {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "media"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "size" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "size"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "speed" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "speed"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "customSpeed" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "customSpeed"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "title" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "title"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "artist" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "artist"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "album" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "album"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "genre" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "genre"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "year" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "year"), node: nil)
        }
        if let variableCall = call.first(where: { node in return node.slotName == "artwork" })?.item {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "encodeMedia", name: "artwork"), node: nil)
        }
