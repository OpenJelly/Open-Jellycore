...
struct GetItemFromListParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let variableCall = call.first(where: { node in return node.slotName == "list" })?.item {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "getItemFromList", name: "list"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "type" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "getItemFromList", name: "type"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "index" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "getItemFromList", name: "index"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "startIndex" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "getItemFromList", name: "startIndex"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "endIndex" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "getItemFromList", name: "endIndex"), node: nil)
        }
