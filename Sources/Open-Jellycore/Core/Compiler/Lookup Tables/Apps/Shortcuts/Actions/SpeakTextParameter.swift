...
struct SpeakTextParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "text" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "speakText", name: "text"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "wait" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "speakText", name: "wait"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "rate" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "speakText", name: "rate"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "pitch" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "speakText", name: "pitch"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "language" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "speakText", name: "language"), node: nil)
        }
