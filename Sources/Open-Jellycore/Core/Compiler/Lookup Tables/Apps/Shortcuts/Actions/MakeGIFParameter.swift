...
struct MakeGIFParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let variableCall = call.first(where: { node in return node.slotName == "content" })?.item {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "content"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "frameTime" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "frameTime"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "loopOn" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "loopOn"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "loopCount" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "loopCount"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "autoSize" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "autoSize"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "width" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "width"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "height" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "makeGIF", name: "height"), node: nil)
        }
