...
struct SpokenAudioFromTextParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "text" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "spokenAudioFromText", name: "text"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "language" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "spokenAudioFromText", name: "language"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "pitch" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "spokenAudioFromText", name: "pitch"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "rate" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "spokenAudioFromText", name: "rate"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "voice" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "spokenAudioFromText", name: "voice"), node: nil)
        }
