...
struct AddContactParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "lastName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "lastName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "firstName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "firstName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "jobTitle" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "jobTitle"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "companyName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "companyName"), node: nil)
        }
        if let variableCall = call.first(where: { node in return node.slotName == "image" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "image"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "group" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "group"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addEmail1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "addEmail1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "email1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "email1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "email1Type" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "email1Type"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addEmail2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "addEmail2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "email2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "email2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "email2Type" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "email2Type"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addPhone1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "addPhone1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "phone1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "phone1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "phone1Type" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "phone1Type"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addPhone2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "addPhone2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "phone2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "phone2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "phone2Type" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "phone2Type"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addAddress1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "addAddress1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "address1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "address1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "location1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "location1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addAddress2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "addAddress2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "address2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "address2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "location2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "location2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "url" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "url"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "birthday" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "birthday"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "note" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "addContact", name: "note"), node: nil)
        }
