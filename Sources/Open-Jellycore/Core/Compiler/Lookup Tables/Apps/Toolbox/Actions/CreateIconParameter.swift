...
struct CreateIconParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "creationMode" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "creationMode"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "defaultIcons" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "defaultIcons"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "bgColour" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "bgColour"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "iconColour" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "iconColour"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "sfSymbolName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "sfSymbolName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "emojiName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "emojiName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "iconColourHex" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "iconColourHex"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "bgColourHex" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "bgColourHex"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "emojiBgColourHex" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "emojiBgColourHex"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "maskType" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "maskType"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "cornerRadius" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "cornerRadius"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "bgTransparency" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "bgTransparency"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "iconSize" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "iconSize"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "scale" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createIcon", name: "scale"), node: nil)
        }
