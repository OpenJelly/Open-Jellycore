...
struct CreateTextImageParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "inputType" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "inputType"), node: nil)
        }
        if let variableCall = call.first(where: { node in return node.slotName == "richText" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "richText"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "text" }) {
            parameters.text = JellyArray<JellyVariableReference>(parameterItem: value, scopedVariables: scopedVariables)
        } else {
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "text"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "font" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "font"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "fontSize" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "fontSize"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "textColour" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "textColour"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "alignment" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "alignment"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "backgroundColour" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "backgroundColour"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "transparentBG" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "transparentBG"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "autoSize" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "autoSize"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "width" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "width"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "height" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "height"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "paddingLeft" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "paddingLeft"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "paddingRight" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "paddingRight"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "paddingTop" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "paddingTop"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "paddingBottom" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "paddingBottom"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "scaleToFit" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "scaleToFit"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "lineLimit" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "lineLimit"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "lineCount" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "lineCount"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addShadow" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "addShadow"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "shadowColour" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "shadowColour"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "xOffset" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "xOffset"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "yOffset" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "yOffset"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "lineBreak" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "createTextImage", name: "lineBreak"), node: nil)
        }
