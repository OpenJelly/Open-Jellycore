...
struct GlobalVariablesParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "mode" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "mode"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "getVariableListFilter" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "getVariableListFilter"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "deleteVariableListFilter" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "deleteVariableListFilter"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addVariableFilterList" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "addVariableFilterList"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setVariableKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "setVariableKey"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setVariableValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "setVariableValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "getVariableKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "getVariableKey"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "deleteVariableKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "deleteVariableKey"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "getAllMode" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "getAllMode"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "joinMode" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "joinMode"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "newLine" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "newLine"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "addKey"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "addValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "includeCreationDate" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "includeCreationDate"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addDictValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "addDictValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addDictKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "addDictKey"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "getDictVarKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "getDictVarKey"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "getDictValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "getDictValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addDictValueKey" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "globalVariables", name: "addDictValueKey"), node: nil)
        }
