...
struct FindTvShowsParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "advancedSearch" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "advancedSearch"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "query" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "query"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "sortBy" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "sortBy"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "descendingSortOrder" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "descendingSortOrder"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "afterYear" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "afterYear"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "beforeYear" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "beforeYear"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "moreVotesThan" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "moreVotesThan"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "scoreBetterThan" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "scoreBetterThan"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "includingGenres" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "includingGenres"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "excludingGenres" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "excludingGenres"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "includeProviders" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "includeProviders"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "providerRegion" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "providerRegion"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "renderThumbnails" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "renderThumbnails"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "resultCount" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "findTvShows", name: "resultCount"), node: nil)
        }
