...
struct BuildURLParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "scheme" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "scheme"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "host" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "host"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "path" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "path"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "queryItems" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "queryItems"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "user" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "user"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "password" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "password"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "fragment" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "fragment"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addPort" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "addPort"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "port" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "buildURL", name: "port"), node: nil)
        }
