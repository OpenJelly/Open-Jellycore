...
struct BookmarkFileParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "mode" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "mode"), node: nil)
        }
        if let variableCall = call.first(where: { node in return node.slotName == "file" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "file"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "setName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "getName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "getName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "deleteName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "deleteName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "overwriteDupes" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "overwriteDupes"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "bookmarkName" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "bookmarkFile", name: "bookmarkName"), node: nil)
        }
