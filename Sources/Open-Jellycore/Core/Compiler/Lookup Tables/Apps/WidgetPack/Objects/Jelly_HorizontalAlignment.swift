...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "identifier", functionName: "HorizontalAlignment"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "displayString", functionName: "HorizontalAlignment"), textPosition: node.textPosition)
//            }
//        }
    }
}
