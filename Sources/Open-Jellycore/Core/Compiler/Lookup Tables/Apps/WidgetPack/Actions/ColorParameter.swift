...
struct ColorParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "kind" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "color", name: "kind"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "hex" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "color", name: "hex"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "customRed" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "color", name: "customRed"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "customGreen" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "color", name: "customGreen"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "customBlue" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "color", name: "customBlue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "opacity" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "color", name: "opacity"), node: nil)
        }
