...
struct VerbatimTextParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "verbatim" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "verbatim"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "font" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "font"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "color" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "color"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "bold" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "bold"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "italic" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "italic"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "strikethrough" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "strikethrough"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "strikethroughColor" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "strikethroughColor"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "underline" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "underline"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "underlineColor" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "underlineColor"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "kerning" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "kerning"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "tracking" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "tracking"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "baselineOffset" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "verbatimText", name: "baselineOffset"), node: nil)
        }
