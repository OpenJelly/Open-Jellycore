...
struct WidgetPack_TextParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "kind" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "kind"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "verbatim" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "verbatim"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "date" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "date"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "dateStyle" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "dateStyle"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "font" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "font"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "color" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "color"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "bold" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "bold"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "italic" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "italic"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "strikethrough" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "strikethrough"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "strikethroughColor" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "strikethroughColor"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "underline" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "underline"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "underlineColor" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "underlineColor"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "kerning" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "kerning"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "tracking" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "tracking"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "baselineOffset" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "text", name: "baselineOffset"), node: nil)
        }
