...
struct Actions_CombineListsParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "list1" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list1"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list2" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list2"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list3" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list3"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list4" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list4"), node: nil)
        }
        if let variableCall = call.first(where: { node in return node.slotName == "list5" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list5"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list6" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list6"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list7" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list7"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list8" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list8"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list9" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list9"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "list10" }) {
            ...
            EventReporter.shared.reportError(error: .missingParameter(function: "combineLists", name: "list10"), node: nil)
        }
