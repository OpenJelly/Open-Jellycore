...
struct EditEventParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "eventID" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "eventID"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "editType" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "editType"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "title" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "title"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "startDate" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "startDate"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "endDate" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "endDate"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "notes" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "notes"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "location" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "location"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "url" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "url"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "availability" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "availability"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "calendar" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "calendar"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "editRecurring" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editEvent", name: "editRecurring"), node: nil)
        }
