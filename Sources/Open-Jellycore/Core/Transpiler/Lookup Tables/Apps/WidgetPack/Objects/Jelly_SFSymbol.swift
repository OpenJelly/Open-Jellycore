...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "identifier", functionName: "SFSymbol"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "displayString", functionName: "SFSymbol"), textPosition: node.textPosition)
//            }
//        }
    }
}
