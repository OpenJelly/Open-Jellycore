...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "addressDictionary", functionName: "ShortcutsPlacemark"), textPosition: value.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "location", functionName: "ShortcutsPlacemark"), textPosition: value.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "region", functionName: "ShortcutsPlacemark"), textPosition: value.textPosition)
//            }
//        }
    }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "City", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "Country", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "CountryCode", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "FormattedAddressLines", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "Name", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "State", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "Street", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "SubAdministrativeArea", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "SubThoroughfare", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "Thoroughfare", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//            
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "ZIP", functionName: "ShortcutsPlacemark"), textPosition: node.textPosition)
//            }
//        }
    }
}
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "altitude", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "course", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "horizontalAccuracy", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
//            if let value = parameter.parameters.first(where: { node in return node.slotName == "horizontalAccuracy" }) {
//                horizontalAccuracy = JellyDouble(value, scopedVariables: scopedVariables)
//            } else {
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "latitude", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "longitude", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "speed", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "timestamp", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "verticalAccuracy", functionName: "ShortcutsLocation"), textPosition: node.textPosition)
//            }
//        }
    }
}
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "center", functionName: "ShortcutsRegion"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "identifier", functionName: "ShortcutsRegion"), textPosition: node.textPosition)
//            }
...
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "radius", functionName: "ShortcutsRegion"), textPosition: node.textPosition)
//            }
//        }
    }
}
...
//                latitude = JellyDouble(value, scopedVariables: scopedVariables)
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "latitude", functionName: "ShortcutsCenter"), textPosition: node.textPosition)
//            }
//            if let value = parameter.parameters.first(where: { node in return node.slotName == "longitude" }) {
//                longitude = JellyDouble(value, scopedVariables: scopedVariables)
//            } else {
//                ErrorReporter.shared.report(error: .parameterNotFound(parameter: "longitude", functionName: "ShortcutsCenter"), textPosition: node.textPosition)
//            }
//        }
    }
}
