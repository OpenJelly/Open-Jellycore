...
struct EditURLParameter: ParameterProtocol, Codable {
    ...
    static func build(call: [FunctionCallParameterItem], scopedVariables: [Variable]) -> ParameterProtocol {
        ...
        if let value = call.first(where: { node in return node.slotName == "action" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "action"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "queryItemName" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "queryItemName"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "queryItemValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "queryItemValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "addPathComponentValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "addPathComponentValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "appendToQueryValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "appendToQueryValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "appendToFragmentValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "appendToFragmentValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "removeQueryItemsNamedValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "removeQueryItemsNamedValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "username" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "username"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "password" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "password"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setQueryValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "setQueryValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setFragmentValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "setFragmentValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setPathValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "setPathValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setSchemeValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "setSchemeValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "setHostValue" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "setHostValue"), node: nil)
        }
        if let value = call.first(where: { node in return node.slotName == "url" }) {
            ...
            ErrorReporter.shared.reportError(error: .missingParameter(function: "editURL", name: "url"), node: nil)
        }
