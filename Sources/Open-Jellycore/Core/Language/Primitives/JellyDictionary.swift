...
//                    print(self.value)
//                } else {
//                    ErrorReporter.shared.report(error: .syntaxError(error: "Invalid Dictionary Builder Dictionary. There is no dictionary named \(value.content)"), textPosition: value.textPosition)
//                }
//            }
//
//        } else {
...
//                    throw JellyError.syntaxError(error: "")
//                }
//                self.value = convertJSONObjectToShortcutsDictionary(object: jsonDictionary, scopedVariables: scopedVariables)
//                print(self.value)
//
//            } catch let error as NSError {
//                ErrorReporter.shared.report(error: .syntaxError(error: "Invalid JSON dictionary present \(error.localizedDescription)"), textPosition: value.textPosition)
//            }
//        }
    }
...
//                let valueDictionary = JellyString(value, scopedVariables: scopedVariables)
//                let fieldValueItem: [String: Any] = [
...
//                let valueDictionary = JellyString(value, scopedVariables: scopeVariables)
//                let fieldValueItem: [String: Any] = [
//                    "WFItemType": JellyInteger(0),
//                    "WFValue": valueDictionary
//                ]
